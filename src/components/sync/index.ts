...
export type { SyncChangeDetail, SyncChannel, SyncConflict, SyncEvent, SyncField, SyncInput, SyncJson, SyncLabels, SyncListener, SyncLocks, SyncMethod, SyncOp, SyncOptions, SyncRevision, SyncState, SyncStatus, SyncStore } from "./types";
...
declare global {
  ...
  interface HTMLElementEventMap {
    ...
    "nx-sync-auth": CustomEvent<{ op: import("./types").SyncOp }>;
  }
}
